          ...
          <div class="row">
            <div class="col-md-3 text-center animate-box">
              <div class="pricing">
                ...
                <div class="price">
                  <sup class="currency">$</sup>9<small>per month</small>
                </div>
                <p>
            ...
            <div class="col-md-3 text-center animate-box">
              <div class="pricing">
                ...
                <div class="price">
                  <sup class="currency">$</sup>27<small>per month</small>
                </div>
                <p>
                  Far far away, behind the word mountains, far from the
                  countries Vokalia and Consonantia, there live the blind texts.
            ...
            <div class="col-md-3 text-center animate-box">
              <div class="pricing">
                ...
                <div class="price">
                  <sup class="currency">$</sup>74<small>per month</small>
                </div>
                <p>
                  Far far away, behind the word mountains, far from the
                  countries Vokalia and Consonantia, there live the blind texts.
            ...
            <div class="col-md-3 text-center animate-box">
              <div class="pricing">
                ...
                <div class="price">
                  <sup class="currency">$</sup>140<small>per month</small>
                </div>
                <p>
                  Far far away, behind the word mountains, far from the
                  countries Vokalia and Consonantia, there live the blind texts.
